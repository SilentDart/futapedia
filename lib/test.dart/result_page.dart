...
class ResultPage extends StatelessWidget {
  ...
  void _saveTestResult(BuildContext context) {
    // Get the subject name from context or parameters
    // For this example, I'm using a placeholder - adjust as needed
    String subjectId = ModalRoute.of(context)?.settings.arguments as String? ?? "Test";
    ...
    String scoreText = "${percentage.toStringAsFixed(1)}%";
    
    // Save to SharedPreferences
    RecentTestsManager.saveTestResult(
      subjectId: subjectId,
      score: scoreText,
    );
  }
